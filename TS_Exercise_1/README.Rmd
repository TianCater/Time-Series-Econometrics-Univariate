...
```
According to the Hyndman-Khandakar algorithm (Hyndman & Khandakar, 2008), the best model fit (provided the criterion that they are stationary and non-seasonal) would be an seasonal ARMA(3,1)(1,1) model. Therefore 
